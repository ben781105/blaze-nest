...
import PadlockIcon from "/svgs/padlock-icon.svg";
import { useState } from "react";
import goodPassword from "/svgs/good-password-icon.svg";
import badPassword from "/svgs/bad-password-icon.svg";
function ResetPasswordForm(){
    ...
    return(
      <div
      className="w-full max-w-xl flex flex-col border rounded-xl py-20 px-5 relative overflow-x-hidden "
      >
        ...
        <p className="text-center mt-2 text-gray-500">Please enter your new password</p>
        ...
        >
          ...
          <div className="mt-4">
            <p className="flex items-center space-x-2">
                ...
                {isSixChars ? <img src={goodPassword} alt="good-password-icon" width={20}/>: <img src={badPassword} alt="bad-password-icon" width={20}/>}
                </span>
                <span className={isSixChars ? 'text-blue-600 font-medium' : 'text-gray-400'}>
            ...
            <p className="flex items-center space-x-2">
                ...
                {hasNumber ? <img src={goodPassword} alt="good-password-icon" width={20}/>: <img src={badPassword} alt="bad-password-icon" width={20}/>}
                </span>
                <span className={hasNumber ? 'text-blue-600 font-medium' : 'text-gray-400'}>
                atleast 1 number
                </span>
            </p>
            </div>
